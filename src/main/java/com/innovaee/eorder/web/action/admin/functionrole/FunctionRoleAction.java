package com.innovaee.eorder.web.action.admin.functionrole;
...
public class FunctionRoleAction extends BaseAction {

	private static final long serialVersionUID = 1L;
	private static final Logger logger = Logger.getLogger(FunctionRoleAction.class);
	...
	public String doFunctionRole() {
		logger.debug("enter doFunctionRole() method");
		return SUCCESS;
	}
