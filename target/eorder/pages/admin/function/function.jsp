...
<script type="text/javascript">
	function save() {
		var functionNameValue = $("#functionName").val();
		var functionDescValue = $("#functionDesc").val();
		var functionPathValue = $("#functionPath").val();
		var functionParentValue = $("#functionParent").val();
		var functionOrderValue = $("#functionOrder").val();
		$.ajax({
			url:'save.action',
			type:'post',
			data:{functionName:functionNameValue,
				functionDesc:functionDescValue,
				functionPath:functionPathValue,
				functionParent:functionParentValue,
				functionOrder:functionOrderValue},
			dataType:'text',
